                    ...
                    <div class="pl-0">
                        <div class="main-profile-overview">
                            <div class="main-img-user profile-user">
                                <img alt="" src="{{asset('assets_admin_dashboard/assets/img/faces/6.jpg')}}"><a class="fas fa-camera profile-edit" href="JavaScript:void(0);" type="file"></a>
                            </div>
                    ...
                    <div class="tab-content border-left border-bottom border-right border-top-0 p-4">
                        ...
                        <div class="tab-pane" id="settings">
                            <form role="form" action="{{route('update_profile')}}" method="post">
                                ...
                                <div class="form-group">
                                    <label for="Password">Img User</label>
