...
<!-- Favicon -->
<link rel="icon" href="{{asset('assets_admin_dashboard/img/brand/favicon.png')}}" type="image/x-icon"/>
<!-- Icons css -->
...
<!--- Dark-mode css -->
<link href="{{asset('assets_admin_dashboard/css-rtl/style-dark.css')}}" rel="stylesheet">
<!---Skinmodes css-->
